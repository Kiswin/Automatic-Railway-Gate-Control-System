...
![Static Badge](https://img.shields.io/badge/C%2B%2B-blue) | ![Static Badge](https://img.shields.io/badge/Arduino_IDE-cyan) |
![Static Badge](https://img.shields.io/badge/Electronics-red)
...
Realistic warning system
Simple and low-cost prototype
Demonstrates basic embedded automation
Getting Started
Upload the code to Arduino Uno.
Connect the components as per the circuit diagram.
Power the system and move an object in front of the IR sensor to simulate a train.

#Applications

Railway safety system models
School/college engineering projects
Demonstrations of automation using microcontrollers
